...
public sealed class ResilienceExecutionBenchmarks
{
    ...
    public void Setup()
    {
        ...
        var builder = new EricksonLopez.Resilience.Builder.ResiliencePipelineBuilder("benchmark-policy");
        ...
        registry.Register("benchmark-policy", _ecosystemPipeline);
        _executor = new PollyResilienceExecutor(registry);

        _context = ResilienceContext.Create("benchmark-policy");
    }

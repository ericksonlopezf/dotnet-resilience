...
public static class CookbookRecipes
{
    ...
    public static async ValueTask RunRecipe4MediatorResilienceAsync()
    {
        ...
        var continuation = new StructNext<Result<string>>(() => CreateCustomerHandler.Handle(command));
    ...
    private static class CreateCustomerHandler
    {
        public static ValueTask<Result<string>> Handle(CreateCustomerCommand request)
        {

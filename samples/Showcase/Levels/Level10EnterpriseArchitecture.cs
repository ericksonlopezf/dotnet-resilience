...
public static class Level10EnterpriseArchitecture
{
    public static async ValueTask RunAsync()
    {
        ...
        services.AddResiliencePolicy("enterprise-checkout-policy", builder =>
        {
            builder
                .AddRateLimiter(opt =>
                {
        ...
        using (var activity = ResilienceActivitySource.StartExecutionActivity("enterprise-checkout-policy", "ProcessCheckout", tenantId: "CORP-ENTERPRISE", correlationId: "CORR-TX-5544"))
        {
            ...
            if (result.IsSuccess)
            {
                ...
                ResilienceMeter.RecordExecution("enterprise-checkout-policy", "ProcessCheckout", 120.5, isSuccess: true, tenantId: "CORP-ENTERPRISE");
            }
            else
            {
    ...
    {
        public string ResiliencePolicy => "enterprise-checkout-policy";
    }

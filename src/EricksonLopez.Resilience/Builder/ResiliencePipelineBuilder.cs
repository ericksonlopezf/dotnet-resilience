...
public sealed class ResiliencePipelineBuilder : IResiliencePipelineBuilder
{
    ...
    {
        public static Func<ResiliencePipelineBuilder<TResult>, IResiliencePipeline<TResult>>? Factory;
    }
    ...
    private static void ValidateHedgingOptions(HedgingStrategyOptions options)
    {
